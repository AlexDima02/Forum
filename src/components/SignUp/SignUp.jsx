        ...
        <form onSubmit={(e) => handleSubmit(e)} action="POST" className='p-5 m-auto md:w-1/2'>
            ...
            <div className='w-4/5 flex flex-col h-96 place-content-between'>
                ...
                <div className='flex flex-col w-full'>
                    ...
                    <label  className='text-white' htmlFor="email">Enter your name:</label>
                ...
                <button disabled={loading} className='w-full bg-button-color text-white py-1 font-bold rounded-sm' type='submit'>Sign up</button>
            </div>
            </div>
        </form>
      </>
